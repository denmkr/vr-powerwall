...
namespace Valve.VR
{
    ...
    public class SteamVR_Input_ActionSet_default : Valve.VR.SteamVR_ActionSet
    {
        ...
        public virtual SteamVR_Action_Boolean DrawingTriggerAction
        {
            get
            {
                return SteamVR_Actions.default_DrawingTriggerAction;
            }
        }
        
        public virtual SteamVR_Action_Boolean AdjustCanvasAction
        {
            get
            {
                return SteamVR_Actions.default_AdjustCanvasAction;
            }
        }
        
        public virtual SteamVR_Action_Vector2 ColorPickerAction
        {
            get
            {
                return SteamVR_Actions.default_ColorPickerAction;
            }
        }
        
        public virtual SteamVR_Action_Boolean ButtonClickAction
        {
            get
            {
                return SteamVR_Actions.default_ButtonClickAction;
            }
        }
        
        public virtual SteamVR_Action_Boolean CreateShapeAction
        {
            get
            {
                return SteamVR_Actions.default_CreateShapeAction;
            }
        }
